...
public class EopConfig {
	 ...
	 * 测试地址，生产地址见下面
	 */
	public final static String url = "http://demo.mall.10010.com:8104/phw-eop";
	/**
	 * 联通商城提供
	 */
	public final static String appcode = "A61BCDE3476C4E2F96A92B1C8D1F01B1";
	/**
	 * 联通商城提供
	 */
	public final static String signKey = "Ac32WEfgqOIzl2pLu8fTS/xp/u9HR8nwYP2wSDL9wXxz8GJFCPQY4Vl9SSm9OiXQtqqtdkmCNvtYK5YTni3CAw==";

	/********************** 身份验证配置 ************************************/
	public final static String APP_CODE = "2ED13AE2598640C8B63407E0FC38646B";
