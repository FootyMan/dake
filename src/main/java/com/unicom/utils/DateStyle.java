...
public enum DateStyle {
	MM_DD("MM-dd"), YYYY_MM("yyyy-MM"), YYYY_MM_DD("yyyy-MM-dd"), YYYYMMDD("yyyyMMdd"), YYYYMMDDHHmmssSSS(
			"yyyyMMddHHmmssSSS"),

	MM_DD_HH_MM("MM-dd HH:mm"), MM_DD_HH_MM_SS("MM-dd HH:mm:ss"), YYYY_MM_DD_HH_MM(
